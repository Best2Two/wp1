        ...
        "query": {
            "pages": {
                74370036: {
                    "pageid": 74370036,
                    "ns": 2,
                    "title": "User:Audiodude/Books/test",
                    "revisions": [
                        {
                            "slots": {
                                "main": {
...
:[[John Smith (explorer)]]""",
    ...
    def setUp(self):
        ...
        self.builder_model = Builder(
            ...
            b_params='{"url":"https://en.wikipedia.fake/wiki/User:Audiodude/Books/test"}',
        )
    ...
    def test_validate_missing_url(self):
        actual = self.builder.validate(project="en.wikipedia.fake")
